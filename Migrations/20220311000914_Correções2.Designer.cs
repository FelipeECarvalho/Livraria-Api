...
namespace Livraria.Migrations
{
    ...
    [Migration("20220311000914_Correções2")]
    partial class Correções2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Livraria.Models.Books.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "Slug" }, "IX_Reviews_Slug")
                        .IsUnique();
            ...
            modelBuilder.Entity("Livraria.Models.Users.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "Slug" }, "IX_Addresses_Slug")
                        .IsUnique();
            ...
            modelBuilder.Entity("Livraria.Models.Users.Address", b =>
                {
                    b.HasOne("Livraria.Models.Users.User", "User")
                        .WithOne("Address")
                        .HasForeignKey("Livraria.Models.Users.Address", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
